...
<script type="text/javascript">
  function triggerbat() {
    //location.href = "C:/xampp/htdocs/testlink/run.bat"
    var TstConfigExcelLoc = "C:\\xampp\\htdocs\\testlink\\run.bat";
...
//    if (string.charAt(string.length - 1) == "/") string = string.substr(0, string.length - 1);
    ...
    //MyObject = new ActiveXObject("WScript.Shell");
         ...
         wshShell.Run(TstConfigExcelLoc);
...
<form method="post" id="execSetResults" name="execSetResults" 
  ...
  {if !($cfg->exec_cfg->show_testsuite_contents && $gui->can_use_bulk_op)}
    <div class="groupBtn">
      ...
      <!-- <input type="button" name="Run" id="run" value="Run" onclick="Trigger();" /> -->
      ...
      <!-- <a href="run.bat" >Click Me!</a> -->
      <!-- <input type="button" value="Run" onclick="triggerbat()"> -->
