...
function initTopMenu(&$db)
{
  ...
  if (isset($_SESSION['testprojectID']) && $_SESSION['testprojectID'] > 0)
  {
            ...
            $_SESSION['testprojectOptions']->requirementsEnabled))
      {
        ...
        if( $addItem )
        {
          ...
          if( isset($element['imgKey']) )
          {
           ...
           $_SESSION['testprojectTopMenu'] .=    '<button type="button" class="btn btn-primary">Home</button>';
    ...
    /*$_SESSION['testprojectTopMenu'] .=    '<button type="button" class="btn btn-primary">Home</button>';
    $_SESSION['testprojectTopMenu'] .=    '<button type="button" class="btn btn-primary">Home</button>';*/
    $_SESSION['testprojectTopMenu'] .=    '<a href="index.php" class="btn" target="mainframe" style="color:white">Home</a>';
    $_SESSION['testprojectTopMenu'] .=    '<a href="lib/general/frmWorkArea.php?feature=reqSpecMgmt" class="btn" target="mainframe" style="color:white">Requirements</a>';
    $_SESSION['testprojectTopMenu'] .=    '<a href="lib/general/frmWorkArea.php?feature=editTc" class="btn" target="mainframe" style="color:white">TestSpecification</a>';
    $_SESSION['testprojectTopMenu'] .=    '<a href="lib/general/frmWorkArea.php?feature=executeTest" class="btn" target="mainframe" style="color:white">Exceution</a>';
    $_SESSION['testprojectTopMenu'] .=    '<a href="lib/general/frmWorkArea.php?feature=showMetrics" class="btn" target="mainframe" style="color:white">Report</a>';
    $_SESSION['testprojectTopMenu'] .=    '<a href="lib/usermanagement/usersView.php" class="btn" target="mainframe" style="color:white">UserRoles</a>';
    $_SESSION['testprojectTopMenu'] .=    '<a href="lib/events/eventviewer.php" class="btn" target="mainframe" style="color:white">Events</a>';
    /*$_SESSION['testprojectTopMenu'] .=    '<input type="button" name="go_back" value="go_back" target="mainframe"';
    $_SESSION['testprojectTopMenu'] .= "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";*/
