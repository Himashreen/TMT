...
function renderFirstPage($doc_info)
{
  ...
  if ($docCfg->company_logo != '' )
  {
   ...
   /* $output .= '<p style="text-align: center;"><img alt="TestLink logo" ' .
           ...
           $output .= '<div style="text-align: center;"><table style="width:179%;"><tr><td><img alt="TestLink logo" ' .
               'title="configure using $tlCfg->document_generator->company_logo" ' . $height .
  ' src="' . $_SESSION['basehref'] . TL_THEME_IMG_DIR . $docCfg->company_logo . '" /</td><td><img alt="TestLink logo" ' .
               'title="configure using $tlCfg->document_generator->company_logo" ' . $height .
  ' src="' . $_SESSION['basehref'] . TL_THEME_IMG_DIR . $docCfg->Client_company_logo  . '" /</td></tr></table></div>';
  }
  $output .= "</div>\n";
